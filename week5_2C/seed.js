...
const books = [
  ...
  },
  {
    ...
    summary:
      "A ruined Italian villa at the end of WWII, four strangers with intersecting pasts confront memory, identity, and loss.",
...
async function seedDatabase() {
  try {
    ...
    console.log("Five books seeded successfully");
  } catch (error) {
